...
; (default "64")
opcache.memory_consumption = {{OPCACHE_ENABLE_MEMORY_CONSUMPTION}}
...
; (default "5")
opcache.max_wasted_percentage = {{OPCACHE_MAX_WESTED_PERCENTAGE}}
...
; to "0".
; (default "2")
opcache.file_update_protection = {{OPCACHE_FILE_UPDATE_PROTECTION}}
...
; need them anyway.
; (default "1")
opcache.load_comments = {{OPCACHE_LOAD_COMMENTS}}
